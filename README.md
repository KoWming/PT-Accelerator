...
services:
  pt-accelerator:
    image: kowming/pt-accelerator:latest
...
- ✅ **日志显示策略优化**：前端日志采用极简模式，移动端通知保留详细信息，拒绝刷屏
- ✅ **任务执行稳定性**：修复定时任务因网络或子进程卡死导致的“僵死”问题，增加全局超时保护
- ✅ **脚本交互优化**：Shell脚本增加交互超时自动兜底机制，防止非交互环境下任务挂起
- ✅ **默认IP统一**：统一全链路默认Cloudflare IP配置，确保行为一致性
