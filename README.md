...
- ✅ **UI交互升级**：Trackers 列表现已支持名称、域名、IP、状态等多字段动态点击正反向排序。
- ✅ **修复批量操作缺陷**：修复批量更新IP时“确定更新”按钮悬停样式丢失以及响应未更新问题。
- ✅ **增强批量添加稳定性**：彻底修复 Tracker 批量添加后无法持久化刷新引致消失的错误配置重写问题。
