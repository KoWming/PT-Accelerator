              ...
              <section class="notification-form-panel notification-form-panel-main">
                <div class="notification-form-panel-head notification-form-panel-head-inline">
                  ...
                  <div class="form-check form-switch notification-switch-item notification-switch-item-inline notification-switch-item-compact">
                    <input type="checkbox" class="form-check-input" id="enable" v-model="form.enabled">
              ...
              <div v-if="form.type === 'slack'">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" v-model="form.SLACK_WEBHOOK_URL" required placeholder="https://hooks.slack.com/services/...">
                  </div>
                  <div class="form-text field-tip">填写 Slack Incoming Webhook 地址，通知将以纯文本消息发送到目标频道。</div>
                </div>
              </div>
...
import { NOTIFY_TYPE_OPTIONS } from '@/utils/notify';
...
const notificationTypeOptions = NOTIFY_TYPE_OPTIONS;
...
const form = reactive<any>({
  ...
  TG_BOT_TOKEN: '', TG_USER_ID: '', TG_API_HOST: '', TG_PROXY_HOST: '', TG_PROXY_PORT: '', TG_PROXY_AUTH: '',
...
onMounted(() => {
  ...
  if (props.initialData) {
    const initialConfig = props.initialData.config || {};
    Object.assign(form, initialConfig, props.initialData);
