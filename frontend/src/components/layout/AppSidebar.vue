  ...
  <aside class="sidebar" :class="{ 'sidebar-open': isOpen, 'sidebar-highlights-initializing': !hasInitializedHighlights }">
    ...
    <div class="sidebar-content">
      <ul ref="mainNavRef" class="nav flex-column px-3">
        ...
        <li class="nav-item">
          <router-link to="/settings/ikuai-dns" class="nav-link" active-class="active" data-nav-key="remote-sync">
            <i class="bx bx-sync nav-icon nav-icon-remote-sync"></i>


            <span class="nav-label">远程同步管理</span>
          </router-link>
        </li>
        ...
        <li class="nav-item nav-group" :class="{ open: isSettingsGroupOpen }">
          ...
          <div class="nav-group-children-wrapper">
            <div ref="settingsSubmenuRef" class="nav-submenu">
              ...
              <router-link to="/settings/cfst" class="nav-sublink" :class="{ active: isSettingsRoute && activeSettingsTab === 'cfst' }" data-subnav-key="cfst">
                <span class="nav-submenu-dot"></span>
                <span class="nav-label">CFST设置</span>
              </router-link>
              ...
              <router-link to="/settings/about" class="nav-sublink" :class="{ active: isSettingsRoute && activeSettingsTab === 'about' }" data-subnav-key="about">
                <span class="nav-submenu-dot"></span>
...
const isIkuaiDnsRoute = computed(() => route.path.startsWith('/settings/ikuai-dns'));
const isSettingsRoute = computed(() => route.path.startsWith('/settings') && !isIkuaiDnsRoute.value);
const activeMainKey = computed(() => {
  ...
  if (isIkuaiDnsRoute.value) return 'remote-sync';
...
const activeSettingsTab = computed(() => {
  ...
  if (route.path.startsWith('/settings/cfst') || route.path.startsWith('/settings/test')) return 'cfst';
  if (route.path.startsWith('/settings/ikuai-dns')) return 'ikuai-dns';
